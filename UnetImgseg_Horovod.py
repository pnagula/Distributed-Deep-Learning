...
def get_unet():
    ...
    opt = keras.optimizers.Adam(.001 * hvd.size())
...
#
    ...
    if hvd.rank() == 0:
       callbacks.append(keras.callbacks.ModelCheckpoint('/workspace/checkpoint-{epoch}.h5',monitor='val_loss', save_best_only=True))
    #model_checkpoint = ModelCheckpoint('weights.h5', monitor='val_loss', save_best_only=True)

    print('-'*30)
    print('Fitting model...')
    print('-'*30)
    model.fit(imgs_train, imgs_mask_train, batch_size=8, epochs=10,  shuffle=True,
